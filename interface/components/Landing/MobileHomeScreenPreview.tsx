  ...
  return (
    <div className="relative flex h-full w-full flex-col justify-between bg-paper font-sans select-none overflow-hidden">
      ...
      <div className="flex-1 overflow-y-auto px-5 pb-20 no-scrollbar">
        ...
        <div className="relative mt-4 overflow-hidden rounded-2xl border border-rule bg-onyx p-4">
          <div
            aria-hidden="true"
        ...
        <div className="grid grid-cols-2 gap-2.5">
          {subjects.map((sub) => (
            <div
              key={sub.id}
              className="flex flex-col justify-between rounded-2xl border border-rule bg-paper-card p-3 transition-transform active:scale-95"
            >
      ...
      <div className="absolute inset-x-4 bottom-3 z-20 flex items-center gap-2">
        <div className="flex h-11 flex-1 items-center justify-around rounded-full border border-rule/80 bg-paper px-3">
        ...
        <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-onyx text-paper">

...
<body>
	...
	<div class="wrapper">
		...
		<img
			class="logo"
			src="https://ik.imagekit.io/cin2tn3bj/korasa_logo_cropped.png"
			alt="Korasa"
			width="72"
			height="72"
		/>
		...
		<p class="body-text">
			Use the code below to verify %s and finish setting up your account.
		</p>
...
`, safeTo, safeCode, year)
	...
	log.Printf(
		"Verification code sent to %s. Email ID: %s",
		to,
		sent.Id,
	)
